...
- Big Buck Bunny at `1280x720 @ 24 fps`
- normally the smallest clip that proves the behavior, even 2 frames when a KEY→INTER transition is enough
- use more frames only when needed to exercise references/GOP/quality behavior; longer runs such as 240 frames / 10 seconds are optional soak/regression evidence, not the required proof size
