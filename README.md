...
- normally a 5-10 frame clip for proof runs, chosen to exercise meaningful low-delay/inter/reference behavior
- longer runs such as 240 frames / 10 seconds are optional soak/regression evidence, not the required proof size
