...
`include "av1_tx4x4_chroma_tables.vh"
    ...
    // 128-high checkpoints, and now the 1728/1792/1856/1920/1984x128 full-coeff reduced
    ...
    wire        me_fullcoeff_tall_public_clean =
        ...
        ((FRAME_WIDTH == 1792) && (FRAME_HEIGHT == 128)) ||
        ((FRAME_WIDTH == 1856) && (FRAME_HEIGHT == 128)) ||
        ((FRAME_WIDTH == 1920) && (FRAME_HEIGHT == 128)) ||
        ((FRAME_WIDTH == 1984) && (FRAME_HEIGHT == 128));
