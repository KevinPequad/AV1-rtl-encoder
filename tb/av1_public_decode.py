...
def public_decode_proof(
    *,
    ...
    cmp_file(ff_sw, recon_yuv, "FFmpeg software IVF decode matches RTL recon")
    ...
    cmp_file(ff_rtl, recon_yuv, "FFmpeg RTL IVF decode matches RTL recon")

    run(["aomdec", "--codec=av1", "--rawvideo", "--i420", "-o", aom_rtl, rtl_ivf])
    cmp_file(aom_rtl, recon_yuv, "aomdec RTL IVF decode matches RTL recon")
