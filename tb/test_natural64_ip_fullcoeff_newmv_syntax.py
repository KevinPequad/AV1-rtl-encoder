...
through the first 24 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 24:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 24 blocks, saw {newmv}")
