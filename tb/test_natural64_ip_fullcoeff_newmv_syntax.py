...
through the first 23 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 23:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 23 blocks, saw {newmv}")
