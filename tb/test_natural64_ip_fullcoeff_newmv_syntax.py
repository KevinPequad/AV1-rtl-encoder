...
through the first 27 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 27:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 27 blocks, saw {newmv}")
