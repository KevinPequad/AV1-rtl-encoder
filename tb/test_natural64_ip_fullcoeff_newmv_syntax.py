...
through the first 22 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 22:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 22 blocks, saw {newmv}")
