...
through the first 32 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 32:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 32 blocks, saw {newmv}")
