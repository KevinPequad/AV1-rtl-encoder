...
through the first 37 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 37:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 37 blocks, saw {newmv}")
