...
through the first 28 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 28:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 28 blocks, saw {newmv}")
