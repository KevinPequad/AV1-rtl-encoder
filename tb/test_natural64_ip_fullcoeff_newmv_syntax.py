...
through the first 33 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 33:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 33 blocks, saw {newmv}")
