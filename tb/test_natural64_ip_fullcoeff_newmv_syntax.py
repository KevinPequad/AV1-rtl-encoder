...
through the first 31 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 31:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 31 blocks, saw {newmv}")
