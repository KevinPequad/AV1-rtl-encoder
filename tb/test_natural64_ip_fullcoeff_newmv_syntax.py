...
through the first 30 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 30:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 30 blocks, saw {newmv}")
