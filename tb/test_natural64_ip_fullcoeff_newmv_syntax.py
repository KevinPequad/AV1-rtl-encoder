...
through the first 15 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 15:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 15 blocks, saw {newmv}")
