...
through the first 29 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 29:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 29 blocks, saw {newmv}")
