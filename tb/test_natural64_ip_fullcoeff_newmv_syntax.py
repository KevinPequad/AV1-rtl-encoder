...
through the first 16 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 16:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 16 blocks, saw {newmv}")
