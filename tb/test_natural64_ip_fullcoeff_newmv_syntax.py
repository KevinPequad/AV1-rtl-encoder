...
through the first 25 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 25:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 25 blocks, saw {newmv}")
