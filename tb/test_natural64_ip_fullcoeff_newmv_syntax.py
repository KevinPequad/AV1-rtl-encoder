...
through the first 13 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 13:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 13 blocks, saw {newmv}")
