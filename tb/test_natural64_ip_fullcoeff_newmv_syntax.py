...
through the first 18 requested NEWMV blocks. Larger explicit NEWMV requests are
...
def main() -> int:
    ...
    if newmv != 18:
        fail(f"expected 64x64 full-coeff NEWMV cap to hold at 18 blocks, saw {newmv}")
