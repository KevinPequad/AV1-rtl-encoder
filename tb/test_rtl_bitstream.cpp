...
int main(int argc, char** argv) {
    ...
    bool ok = true;
    ok &= expect_eq("sequence_header", seq_header, build_expected_seq());
    ok &= expect_eq("video_keyframe_header", key_header, build_expected_key(qindex));
    ok &= expect_eq("video_inter_header", inter_header, build_expected_inter(qindex));
