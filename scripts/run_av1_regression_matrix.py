...
CURRENT_GATES: list[Gate] = [
    ...
    Gate("T14", "natural64-ip-fullcoeff-newmv-7frame-syntax-check", make_cmd("natural64-ip-fullcoeff-newmv-7frame-syntax-check"), TB, True, "64x64 7-frame full-coeff unrestricted NEWMV LAST-chain public decoder/recon parity proof"),
    Gate("T15", "natural64-ip-fullcoeff-newmv-8frame-syntax-check", make_cmd("natural64-ip-fullcoeff-newmv-8frame-syntax-check"), TB, True, "64x64 8-frame full-coeff unrestricted NEWMV LAST-chain public decoder/recon parity proof"),
]
...
FUTURE_GATES: list[dict[str, str]] = [
    ...
    {"audit_row": "P8", "name": "ip-10f-last-public-check", "reason": "longer-GOP feature-lane implementation pending beyond the current 8-frame LAST-chain checkpoint; not a pass"},
